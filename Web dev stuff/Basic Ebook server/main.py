...
def Rename_book(folder_name, new_name):
    return 501
...
def Move_book_to_folder(folder_name, book_name, thumb):
    return 501
...
@app.route("lists/<colour>&&<address>&&<option>", methods = ["PUT"])
def Manage_ip_list(colour, address, option):
    return 501
